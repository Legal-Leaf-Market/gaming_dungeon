...
(function () {
  ...
  var ROOMS = [
    { mx:26, my:54, nx:70, ny:16, key:'arcade',        path:'/arcade-floor',  name:'The Arcade Floor', realm:5, band:'#494949',
      epithet:'A sun the size of a seed.',
      blurb:'Cabinets, sticks, and everything that used to eat quarters.' },
    { mx:12, my:77, nx:27, ny:7, key:'play',          path:'/play',          name:'Play',             realm:2, band:'#252525',
      epithet:'Breath by breath, the sea fills.',
      blurb:'Games, keys and the things you actually play.' },
    { mx:17, my:27, nx:28, ny:25, key:'tabletop',      path:'/tabletop',      name:'The Table',        realm:3, band:'#313131',
      epithet:'What is built on stone endures.',
      blurb:'Dice, decks, minis and the four hours you lost to them.' },
    { mx:42, my:69, nx:28, ny:43, key:'battlestation', path:'/battlestation', name:'Battlestation',    realm:4, band:'#3d3d3d',
      epithet:'A whirlpool learns to hold its center.',
      blurb:'The desk. Boards, mice, screens, chairs.' },
    { mx:39, my:22, nx:70, ny:32, key:'workshop',      path:'/workshop',      name:'The Workshop',     realm:1, band:'#191919',
      epithet:'Flesh is the first furnace.',
      blurb:'Parts, printers and the rig you keep almost finishing.' },
    { mx:57, my:45, nx:70, ny:48, key:'audio',         path:'/audio',         name:'Audio',            realm:9, band:'#797979',
      epithet:'The way walks with you now.',
      blurb:'Amps, cans and speakers worth the shelf.' },
    { mx:73, my:75, nx:28, ny:79, key:'power',         path:'/power',         name:'Power',            realm:8, band:'#6d6d6d',
      epithet:'Emptiness, polished until it shines.',
      blurb:'Chargers, cables, and the brick you keep losing.' },
    { mx:69, my:20, nx:28, ny:61, key:'vault',         path:'/vault',         name:'The Vault',        realm:6, band:'#555555',
      epithet:'The self that steps outside the self.',
      blurb:'Figures, manga, plush and things kept in the box.' },
    { mx:88, my:50, nx:70, ny:64, key:'wardrobe',      path:'/wardrobe',      name:'The Wardrobe',     realm:7, band:'#616161',
    ...
    { mx:55, my:16, nx:70, ny:80, key:'walls',         path:'/walls',         name:'The Walls',        realm:10, band:'#858585',
  ...
  function renderMap() {
    ...
    pins.push({
      r: { key:'arcade-stick', path:'/arcade', name:'The Arcade', band:'#919191',
