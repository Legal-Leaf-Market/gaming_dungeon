...
export const ROOMS_META = [
  ...
  /* REALM 10 IS SPENT, AND HERE IS THE CLAIM.
     ...
     band on the map. */
  { key:'walls',         name:'The Walls',        realm:10, band:'#858585',
